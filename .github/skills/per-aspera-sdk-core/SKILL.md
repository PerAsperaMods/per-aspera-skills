...
- `PerAspera.Core.IL2CppExtensions` — IL2CPP ↔ C# interop helpers
...
```
F:\ModPeraspera\SDK\PerAspera.Core\
F:\ModPeraspera\SDK\PerAspera.Abstractions\
F:\ModPeraspera\SDK\PerAspera.Core.IL2CppExtensions\
```
