...
> Source : `F:\ModPeraspera\Tools\lispyExtract\BaseGame.cs` + `Universe.cs`
...
// ❌ FAUX — Type nu sans System.
Type _buildingType;     // conflict d'assembly IL2CPP
System.Type _buildingType;  // ✅ CORRECT
...
> Source : `F:\ModPeraspera\Tools\lispyExtract\` (IL2CPP dump réel du jeu)
...
|--------|---------------|
| `BaseGame.cs` | `F:\ModPeraspera\Tools\lispyExtract\BaseGame.cs` |
| `Universe.cs` | `F:\ModPeraspera\Tools\lispyExtract\Universe.cs` |
| `Planet.cs` | `F:\ModPeraspera\Tools\lispyExtract\Planet.cs` |
| `Faction.cs` | `F:\ModPeraspera\Tools\lispyExtract\Faction.cs` |
| `Keeper.cs` | `F:\ModPeraspera\Tools\lispyExtract\Keeper.cs` |
| `KeeperMap.cs` | `F:\ModPeraspera\Tools\lispyExtract\KeeperMap.cs` |
| `Handle.cs` | `F:\ModPeraspera\Tools\lispyExtract\Handle.cs` |
| `IHandleable.cs` | `F:\ModPeraspera\Tools\lispyExtract\IHandleable.cs` |
| `Building.cs` | `F:\ModPeraspera\Tools\lispyExtract\Building.cs` |
| `ABCBuilding.cs` | `F:\ModPeraspera\Tools\lispyExtract\ABCBuilding.cs` |
| `Atmosphere.cs` | `F:\ModPeraspera\Tools\lispyExtract\Atmosphere.cs` |
| Toutes les classes | `F:\ModPeraspera\Tools\lispyExtract\` |

### 📚 Documentation de référence

| Document | Chemin |
|---------|--------|
| Index classes ScriptAssembly | `F:\ModPeraspera\Internal_doc\SCRIPTASSEMBLY-CLASSES-INDEX.md` |
| Architecture BaseGame/Keeper | `F:\ModPeraspera\Internal_doc\ARCHITECTURE\BaseGame-Architecture-Corrections.md` |
| Handle System complet | `F:\ModPeraspera\Internal_doc\ARCHITECTURE\Handle-System-Architecture.md` |
| Planet getters complets | `F:\ModPeraspera\Internal_doc\PlanetGetters-Reference.md` |
| Patterns validés | `F:\ModPeraspera\Internal_doc\ARCHITECTURE\VALIDATED-PATTERNS.md` |
| Scene Architecture | `F:\ModPeraspera\Internal_doc\ARCHITECTURE\Scene-Management-Architecture.md` |
| Interaction System | `F:\ModPeraspera\Internal_doc\ARCHITECTURE\Interraction-System-Analysis.md` |
