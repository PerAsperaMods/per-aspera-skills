...
- `F:\ModPeraspera\SDK\PerAspera.GameAPI.Database\ModDatabase.cs` — implémentation complète
- `F:\ModPeraspera\SDK\PerAspera.GameAPI.Database\EnhancedDatabaseExamples.cs` — 7 exemples
- `F:\ModPeraspera\SDK\PerAspera.GameAPI.Database\EnhancedDatabase-README.md` — architecture SQLite
